...
function Category() {
  ...
  const openUpdateCategoryForm = (data) => {
  ...
  const openDeleteCategoryForm = (data) => {
    setSelectedData(data);
  ...
  }, [showUpdateCategoryForm, selectedData])
  ...
  return (
    <>
      ...
      <div className="flex flex-1 lg:mr-32 my-3">
          ...
          <div>
            <Button onClick={openAddCategoryForm}>Add Category</Button>
          </div>
      </div>
              ...
              <TableRow key={i}>
                ...
                <TableCell className="text-center" style={{justifyItems: "center"}}>
                  <div className="flex items-center space-x-4">
                    <Button layout="link" size="icon" aria-label="Edit" onClick={()=>openUpdateCategoryForm(data)}>
                      <EditIcon className="w-5 h-5" aria-hidden="true" />
                    </Button>
                    <div className='hidden'>
                      <Button layout="link" size="icon" aria-label="Delete" onClick={()=>openDeleteCategoryForm(data)}>
      ...
      {/* Add Category Form */}
      <Modal id="modal" isOpen={showAddCategoryForm}>
        ...
        <ModalFooter>
          <div className="block">
            <Button layout="outline" onClick={closeAddCategoryForm}>
              Cancel
            </Button>
          </div>
          <div className="block">
      ...
      <Modal id="modal" isOpen={showUpdateCategoryForm}>
        <ModalHeader>Add Category Form</ModalHeader>
        <ModalBody className="max-h-xl overflow-y-auto p-2">
          <Label className="my-5">
            <span>Description</span>
        ...
        <ModalFooter>
          <div className="block">
            <Button layout="outline" onClick={closeUpdateCategoryForm}>
              Cancel
            </Button>
          </div>
          <div className="block">
      ...
      <Modal id="modal" isOpen={showDeleteCategoryForm}>
        <ModalHeader>Delete Category Form</ModalHeader>
        <ModalBody className="max-h-xl overflow-y-auto p-2">
            <span>{`Are you sure you want to delete ${selectedData.description} ?`}</span>
        </ModalBody>
        <ModalFooter>
          <div className="block">
            <Button layout="outline" onClick={closeDeleteCategoryForm}>
              Cancel
            </Button>
          </div>
          <div className="block">
